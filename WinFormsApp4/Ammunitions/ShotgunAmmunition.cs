...
{
    public sealed class ShotgunAmmunition : Ammunition
    {
        ...
        public override AmmunitionPurpose Purpose => AmmunitionPurpose.Hunting;

        public override string Type => "Shotgun";
    }
}
